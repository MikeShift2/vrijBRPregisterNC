...
return [
    ...
    'routes' => [
        ...
        // ZGW Documenten endpoints
        ['name' => 'ZgwDocument#getDocumenten', 'url' => '/zgw/documenten', 'verb' => 'GET'],
        ['name' => 'ZgwDocument#getDocument', 'url' => '/zgw/documenten/{documentId}', 'verb' => 'GET', 'requirements' => ['documentId' => '[^/]+']],
        ['name' => 'ZgwDocument#downloadDocument', 'url' => '/zgw/documenten/{documentId}/download', 'verb' => 'GET', 'requirements' => ['documentId' => '[^/]+']],
        ['name' => 'ZgwDocument#createDocument', 'url' => '/zgw/documenten', 'verb' => 'POST'],
        ['name' => 'ZgwDocument#deleteDocument', 'url' => '/zgw/documenten/{documentId}', 'verb' => 'DELETE', 'requirements' => ['documentId' => '[^/]+']],
    ],
];
